            ...
            Runnable connect = () -> {
                while (true) {
                    try (
                        ...
                        String bufferTest = "";
                        while (true) {
                            bufferTest = in.readLine();
                            if (bufferTest.isEmpty()) {
                                break;
                            } else {
                                System.out.println(bufferTest);
                                builder.append(bufferTest);
                                builder.append("\n");
                            }
                        }
                        String body = "";
                        fullRequest = builder.toString();
                        if (fullRequest.isEmpty()) {

                            System.out.println(fullRequest + "fullRequest is empty");
                        } else {
                            ...
                            try {
                                ...
                                System.out.println(Arrays.toString(partsForBuilder));
                            }
